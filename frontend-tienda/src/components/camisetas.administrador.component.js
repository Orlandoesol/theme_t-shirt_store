...
import RegistrarCamisetas from "./registrar-camisetas.component";
        ...
        return (
            ...
            <div className="container">
                ...
                :
                    ...
                    <div >
                        <div className={classCamisetas.botonRegistrarCamiseta}>
                            <Button className={classCamisetas.seguirComprando} variant="primary" onClick={(e)=> this.setState({mostrar: "registrar"})}>Registrar productos</Button>
                        </div>
