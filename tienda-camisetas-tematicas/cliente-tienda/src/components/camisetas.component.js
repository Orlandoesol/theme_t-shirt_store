                                ...
                                <Card img-alt="Card image" img-top>
                                    ...
                                    :
                                        ...
                                        <div className={classCamisetas.textLeft}>
                                            ...
                                            {/* <div className="m-5-23">
                                                <input type="number"
                                                    :value="item.cantidadDeseada" className="form-control" :max="item.stock" min="0"
                                                    :v-on:change="item.cantidadDeseada > 0? guardarUnidadesDeseadas(item):nule"
                                                >
                                            </div> */}
